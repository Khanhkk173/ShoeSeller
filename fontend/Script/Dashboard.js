...
async function loadOverviewStats() {
    try {
        const response = await fetch('https://earnest-truth-production.up.railway.app/api/statistics/overview', {
            method: 'GET',
...
async function loadRevenueChart(days = 7) {
    try {
        const response = await fetch(`https://earnest-truth-production.up.railway.app/api/statistics/revenue`, {
            method: 'GET',
            credentials: 'include'
        });
