...
async function uploadImages(files) {
    ...
    for (const file of files) {
        try {
            ...
            const res = await fetch("https://earnest-truth-production.up.railway.app/api/uploads/product-image", {
                method: "POST",
                body: formData,
                credentials: "include"
            });
            ...
            urls.push("https://earnest-truth-production.up.railway.app" + urlPath.trim());
        } catch (err) {
...
async function submitImport() {
    ...
    try {
        const res = await fetch("https://earnest-truth-production.up.railway.app/api/imports", {
            method: "POST",
...
async function submitNewProduct() {
    ...
    try {
        const res = await fetch("https://earnest-truth-production.up.railway.app/api/imports/new-product", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                name,
...
async function loadImportHistory() {
    try {
        const res = await fetch("https://earnest-truth-production.up.railway.app/api/imports/history");
        const result = await res.json();
...
async function deleteProduct(productId, productName) {
    ...
    try {
        const res = await fetch(`https://earnest-truth-production.up.railway.app/api/products/${productId}`, { method: "DELETE" });
        const result = await res.json();
        if (res.ok) {
...
async function loadDeletedProducts() {
    try {
        const res = await fetch("https://earnest-truth-production.up.railway.app/api/deleted-products");
        const result = await res.json();
